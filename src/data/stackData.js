...
export const STACK = {
  ...
  database: {
    label: 'Database',
    options: [
      { id: 'postgres', name: 'PostgreSQL', tag: 'SQL', blurb: 'A powerful open-source relational database known for reliability and strict data integrity.', pros: ['Rock-solid and ACID compliant', 'Wide hosting support'], cons: ['Needs a schema and migrations'], install: ['npm install pg'], promptBit: 'a PostgreSQL database', ratings: { performance: 4, scalability: 5, cost: 4 } },
